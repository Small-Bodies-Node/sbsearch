...
namespace sbsearch
{
    namespace testing
    {
        ...
        TEST_F(EphemerisTest, EphemerisStreamOperator)
        {
            ...
            s << eph;
            EXPECT_EQ(s.str(),
                      R"(2P  1      0.00000      10.000     1.000000    0.000000   0.000   1.000   180.000     0.000     0.000      0.00     10.00     1.000     0.100    90.000
2P  1      1.00000      11.000     2.000000    0.000000   1.000   0.000     0.000   180.000    30.000      0.00     20.00     5.000     0.500    90.000
2P  1      2.00000      12.000     3.000000    0.000000   2.000   1.000    90.000    80.000    90.000      0.00     30.00    10.000     1.000    90.000
)");
            s.str("");
            eph.format.show_all_columns = false;
            s << eph;
            EXPECT_EQ(s.str(),
                      R"(2P  1      0.00000      10.000     1.000000    0.000000   0.000   1.000   180.000
2P  1      1.00000      11.000     2.000000    0.000000   1.000   0.000     0.000
2P  1      2.00000      12.000     3.000000    0.000000   2.000   1.000    90.000
)");
        }
