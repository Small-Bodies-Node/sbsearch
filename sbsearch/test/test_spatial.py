...
class TestSpatialIndexer:
    ...
    def test_polygon_intersects_line(
        self, poly_ra, poly_dec, line_ra, line_dec, intersects
    ):
        assert (
            polygon_intersects_line(
                np.radians(poly_ra),
    ...
    def test_polygon_intersects_line(self, s, line_ra, line_dec, intersects):
